...
const addPhone = () => {
      setContractor(() => ({ ...contractor, phone: [...contractor.phone, ""] }));
};

const removePhone = (index) => {
    const updatedPhones = [...contractor.phone];
    updatedPhones.splice(index, 1);
      setContractor((contractor) => ({ ...contractor, phone: updatedPhones }));
};
...
return (
  ...
  <h2 className="text-2xl font-semibold mb-4 text-center">Create Contractor</h2>
      ...
      <div className='mb-4'>
                  ...
                  {contractor.phone.map((tel, index) => (
                      <div key={index} className='mb-4 w-full'>
                          ...
                          className='appearance-none border rounded w-800 py-2 px-3 mr-2 text-gray-600 leading-tight focus:outline-none focus:shadow-outline'
                              ...
                              autoComplete='off'
                              value={tel}
                              onChange={(e) => contractor(e, index)}
                          />
                          {contractor.phone.length > 1 && (
                          <button
